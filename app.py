...
st.set_page_config(page_title="Cheese Pressure Calculator", layout="centered")
...
st.markdown("## Step 3: Cheese Shape Only Affects Pressure on Cheese, Not Applied Force")
